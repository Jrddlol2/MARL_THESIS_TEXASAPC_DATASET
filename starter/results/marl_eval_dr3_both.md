...
| Stage A (D+T) | MARL | 0.412 [0.393, 0.432] | 351 [343, 358] | 4482 |
...
| Ablation S (D+T+S) | MARL | 0.459 [0.429, 0.490] | 361 [350, 372] | 4620 |
...
| Ablation W (observed rain) | MARL | 0.416 [0.395, 0.439] | 352 [344, 360] | 4535 |
...
| Ablation B (D+T+B) | MARL | 0.420 [0.396, 0.446] | 367 [357, 377] | 4552 |
...
| Stage B (observed rain) | MARL | 0.480 [0.447, 0.516] | 380 [367, 396] | 4745 |
...
| Stage B (eta 0.3) | MARL | 0.598 [0.560, 0.637] | 419 [403, 438] | 4903 |
...
| Stage B (eta 0.6) | MARL | 0.763 [0.722, 0.804] | 489 [466, 514] | 5309 |
...
| Stage B (eta 1.0) | MARL | 0.853 [0.817, 0.889] | 536 [512, 561] | 5577 |
...
| Stage B (eta 1.3) | MARL | 0.880 [0.845, 0.916] | 552 [528, 576] | 5601 |

**Acceptance criteria**

- **Stage A (i)** wait no worse than EH: MARL 351 s vs EH 339 s, Holm p(MARL worse) = 0.000 -> FAIL
- **Stage A (ii)** headway CV lower than NC: MARL 0.412 vs NC 0.556, Holm p = 0.000 -> PASS
- **Training gate** headway CV below EH: MARL 0.412 vs EH 0.342, Holm p = 1.000 -> FAIL
- **Stage B** wait below the best baseline in every Stage B cell -> FAIL
  - Stage B (observed rain): MARL wait 380 s vs best baseline EH 361 s, Holm p = 1.000 -> fail
  - Stage B (eta 0.3): MARL wait 419 s vs best baseline EH 399 s, Holm p = 1.000 -> fail
  - Stage B (eta 0.6): MARL wait 489 s vs best baseline EH 472 s, Holm p = 1.000 -> fail
  - Stage B (eta 1.0): MARL wait 536 s vs best baseline EH 524 s, Holm p = 1.000 -> fail
  - Stage B (eta 1.3): MARL wait 552 s vs best baseline FH 541 s, Holm p = 1.000 -> fail
