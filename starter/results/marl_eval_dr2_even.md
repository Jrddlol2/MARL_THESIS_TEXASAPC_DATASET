...
| Stage A (D+T) | MARL | 0.345 [0.325, 0.367] | 342 [335, 349] | 4597 |
...
| Ablation S (D+T+S) | MARL | 0.374 [0.347, 0.401] | 346 [339, 355] | 4727 |
...
| Ablation W (observed rain) | MARL | 0.346 [0.325, 0.367] | 342 [335, 349] | 4650 |
...
| Ablation B (D+T+B) | MARL | 0.387 [0.362, 0.412] | 361 [351, 373] | 4624 |
...
| Stage B (observed rain) | MARL | 0.416 [0.387, 0.447] | 367 [355, 380] | 4811 |
...
| Stage B (eta 0.3) | MARL | 0.528 [0.494, 0.562] | 399 [385, 414] | 4891 |
...
| Stage B (eta 0.6) | MARL | 0.708 [0.671, 0.746] | 467 [447, 489] | 5211 |
...
| Stage B (eta 1.0) | MARL | 0.808 [0.769, 0.846] | 515 [492, 540] | 5450 |
...
| Stage B (eta 1.3) | MARL | 0.834 [0.797, 0.872] | 529 [504, 555] | 5470 |

**Acceptance criteria**

- **Stage A (i)** wait no worse than EH: MARL 342 s vs EH 339 s, Holm p(MARL worse) = 0.044 -> FAIL
- **Stage A (ii)** headway CV lower than NC: MARL 0.345 vs NC 0.556, Holm p = 0.000 -> PASS
- **Training gate** headway CV below EH: MARL 0.345 vs EH 0.342, Holm p = 0.596 -> FAIL
- **Stage B** wait below the best baseline in every Stage B cell -> FAIL
  - Stage B (observed rain): MARL wait 367 s vs best baseline EH 361 s, Holm p = 1.000 -> fail
  - Stage B (eta 0.3): MARL wait 399 s vs best baseline EH 399 s, Holm p = 0.635 -> fail
  - Stage B (eta 0.6): MARL wait 467 s vs best baseline EH 472 s, Holm p = 0.030 -> pass
  - Stage B (eta 1.0): MARL wait 515 s vs best baseline EH 524 s, Holm p = 0.006 -> pass
  - Stage B (eta 1.3): MARL wait 529 s vs best baseline FH 541 s, Holm p = 0.001 -> pass
