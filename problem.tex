...
To evaluate a parameter-sharing Multi-Agent Reinforcement Learning scheduling model under baseline and disturbed operating conditions in a public-data-calibrated simulation of a defined traffic area.
