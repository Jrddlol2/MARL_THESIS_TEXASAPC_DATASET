...
Maximum holding duration & $\Delta T$ & to be finalized (design) during implementation & Section~\ref{subsec:marl-arch} (Action Space) \\
...
Demand-surge scale & $f_d$ & $\mathcal{N}(1,\sigma_d^2)$ with a design-phase $\sigma_d$ and support clipped to $[1,3]$ & Section~\ref{subsec:stochastic-vars} \\
Traffic-speed stress scale & $f_s$ & $\mathcal{N}(1,\sigma_s^2)$ with a design-phase $\sigma_s$ and support clipped to $[0.8,1.2]$ & Section~\ref{subsec:stochastic-vars} \\
Breakdown rate & $\lambda$ & to be finalized (design): declared scenario rate (events per bus-hour); APC contains no failure events & Section~\ref{subsec:stochastic-vars} \\
