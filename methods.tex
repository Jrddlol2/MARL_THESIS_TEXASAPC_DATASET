...
\texttt{rev\_seconds}, \texttt{rev\_distance} & Per-segment running time (\texttt{rev\_seconds} is open-to-open, so the current-stop dwell is netted out) and possible average speed & Travel-time RMSE is primary; distance unit remains unresolved \\
